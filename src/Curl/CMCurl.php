...
class CMCurl
{
    ...
    */
    ...
    {
        $this->option[CURLOPT_COOKIEJAR] = $cookie;
        $this->option[CURLOPT_COOKIEFILE] = $cookie;
    }

    /**
    * @param string
    */
    public function set_useragent($ua="Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.9.1.1) Gecko/20090715 Firefox/3.5.1")
    {
        $this->option[CURLOPT_USERAGENT] = $ua;
    }

    /**
    * @param string
    */
    public function set_socks($socks)
    {
        $this->option[CURLOPT_HTTPPROXYTUNNEL] = true;
        $this->option[CURLOPT_PROXYTYPE] = CURLPROXY_SOCKS5;
        $this->option[CURLOPT_PROXY] = $socks;
    }
    ...
    * @param array
    */
    public function set_optional($op)
    {
    ...
    * @param integer
    */
    public static function get_ua($z)
    {
        switch ($z) {
